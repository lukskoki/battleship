...
def lagano():
    ...
    global count
    global pobjeda
    listofv = [OA,OB,OC,OD,TA,TB,TC,TD,TE,THA,THB,THC,THD,FA,FB,FC,FD,FIA,FIB,FIC,FID,SA,SB,SC,SD,SEA,SEB,SEC,SED,EA,EB,EC,ED]
    formatlist = ['1a', '1b', '1c', '1d','2a', '2b', '2c', '2d','3a', '3b', '3c', '3d', '4a', '4b', '4c', '4d']
    listOfH = []
    while len(listOfH) < 8:
...
def tesko():
    ...
    global count
    global pobjeda
    listofv = [OA,OB,OC,OD,OE,OF,TA,TB,TC,TD,TE,TF,THA,THB,THC,THD,THE,THF,FA,FB,FC,FD,FE,FF,FIA,FIB,FIC,FID,FIE,FIF,SA,SB,SC,SD,SE,SF]
    formatlist = ['1a', '1b', '1c', '1d','1e','1f','2a', '2b', '2c', '2d','2e','2f','3a', '3b', '3c', '3d','3e','3f', '4a', '4b', '4c', '4d','4e','4f','5a', '5b', '5c', '5d','5e','5f','6a', '6b', '6c', '6d','6e','6f']
    listOfH = []
    while len(listOfH) < 8:
        listOfH.append(random.choice(formatlist))
        listOfH = list(set(listOfH))
